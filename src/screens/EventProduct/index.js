...
import { ChevronLeft, ChevronDown, FileText, Plus, Camera, Ticket } from "lucide-react";
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        boxShadow: `0 6px 28px ${A}55, 0 2px 8px rgba(0,0,0,0.30)`,
        outline: "none",
        userSelect: "none",
      }}
    >
      ...
      />
      <Ticket size={16} strokeWidth={2.4} style={{ flexShrink: 0 }} />
