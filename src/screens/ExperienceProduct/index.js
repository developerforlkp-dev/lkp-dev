    ...
    <Page hideBookings hideHeader={isDirectBooking} fooferHide={isDirectBooking}>
      ...
      <main style={{ background: BG }}>
        ...
        <section className="gallery-section" style={{ background: W, padding: "24px 0 32px", overflow: "hidden" }}>
          <div style={{ width: "calc(100% - 80px)", maxWidth: "1600px", margin: "0 auto", position: "relative", overflow: "hidden" }}>
            ...
            {(() => {
              ...
              const galleryDuration = galleryDistance / 18; // reduced marquee speed (18px/s) for slower, smoother glide
        ...
        {(() => {
          ...
          const tagsDuration = tagsDistance / 8; // ultra-slow marquee speed (8px/s) for very calm, subtle motion
        ...
        {(() => {
          ...
          const catsDuration = catsDistance / 8; // ultra-slow marquee speed (8px/s) for very calm, subtle motion
          ...
          <section className="host-quality-section" style={{ background: theme === 'dark' ? BG : W, padding: "64px 0" }}>
            <div style={{ width: "calc(100% - 80px)", maxWidth: "1200px", margin: "0 auto" }}>
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns: isDirectBooking ? "1fr" : "4fr 6fr",
                  maxWidth: isDirectBooking ? "680px" : "100%",
                  margin: isDirectBooking ? "0 auto" : undefined,
                  gap: 64
                }}
                className="host-quality-grid"
              >
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                          ...
                          <div style={{
                            ...
                            <div style={{
                              ...
                              <img
                                src={formatImageUrl(hostData?.profilePhotoUrl || hostData?.profileImageUrl || hostData?.host?.profilePhotoUrl || hostData?.host?.profileImageUrl || hostData?.avatar || hostData?.host?.avatar || leadData?.profilePhotoUrl || leadData?.profileImageUrl) || `https://api.dicebear.com/7.x/initials/svg?seed=${encodeURIComponent(displayHostName)}&backgroundColor=0097B2&color=ffffff`}
