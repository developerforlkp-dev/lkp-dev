...
// (Originally Layout 2 EditorialMagazine from blogpage)
export default function Layout2({ post }) {
  return (
            ...
            <div key={idx} className="bg-white rounded-[32px] p-6 lg:p-10 shadow-sm border border-gray-50 flex flex-col lg:flex-row gap-8 items-center">
              {section.image && (
                <div className="w-full lg:w-[45%] h-[300px] relative rounded-[24px] overflow-hidden flex-shrink-0">
                  <img src={section.image} alt={section.heading} className="absolute inset-0 w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
